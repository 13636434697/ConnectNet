...
public class ApiHttpClient {
    ...
    public final static String HOST_LOCAL = "192.168.14.67";
    private static String API_URL_LOCAL = "http://192.168.14.67:8080/%s";
    ...
    //还是set方法，传进来参数，用静态的变量来接收一下，这样头的信息设置一次就可以了
